 ...
 * for the PURPLE robot. These constants are specific to the PURPLE robot's hardware 
...
// Speed Levels
const int LEFT_SPEEDS[MAX_SPEED]  = {120, (115+255)/2, 255};   // Speed levels for the left motor
const int RIGHT_SPEEDS[MAX_SPEED] = {110, (110+245)/2, 245};   // Speed levels for the right motor

// Servo Angles
#define ARM_ANGLE_UP    0       // Servo angle for the arm in the UP position
