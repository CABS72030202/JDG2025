 ...
 * for the YELLOW robot. These constants are specific to the YELLOW robot's hardware 
...
#define ROBOT_ID        3       // Unique ID to each Arduino : RED is 0, GREEN is 1, BLUE is 2, YELLOW is 3, PURPLE is 4, CONE is 5, BOAT is 6
